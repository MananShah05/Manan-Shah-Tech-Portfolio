          ...
          >
            <div className="relative overflow-hidden p-2">
              ...
              <motion.p
                ...
                className="mt-3 font-mono text-[10px] tracking-[0.4em] text-ink-muted uppercase text-center"
              >
                Creative Designer
              </motion.p>
            </div>
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="group/pill flex items-center gap-2 px-3.5 py-1.5 rounded-full font-mono text-[10px] font-bold tracking-wider uppercase border border-accent bg-accent/5 text-accent hover:bg-accent/10 active:scale-[0.97] transition-all duration-300 cursor-pointer"
            >
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            <button
              onClick={handleToggleMode}
              className="group inline-flex items-center gap-2.5 px-7 py-3.5 border border-dashed border-accent text-accent font-bold text-xs uppercase tracking-tighter transition-strong hover:bg-accent hover:text-accent-ink active:scale-[0.97] cursor-pointer"
            >
