...
```mermaid
graph TD
    A[Vite Server] --> B[React 19 Core]
    B --> C[Tailwind CSS v4 Engine]
    B --> D[Framer Motion 12 Physics]
    B --> E[Three.js / OGL Shader Canvas]
    B --> F[Lenis Smooth Scroll]
    B --> G[Zustand Client Stores]
```
